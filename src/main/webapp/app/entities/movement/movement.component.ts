...
export class MovementComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.movementService
                ...
                .subscribe(
                    (res: HttpResponse<IMovement[]>) => this.paginateMovements(res.body, res.headers),
    ...
    registerChangeInMovements() {
        this.eventSubscriber = this.eventManager.subscribe('movementListModification', response => this.reset());
    }
    ...
    private paginateMovements(data: IMovement[], headers: HttpHeaders) {
